...
const Search = ({query,setQuery}) => {
  ...
  return (
    <div>
      <form onSubmit={handleSubmit} className="mx-auto mt-5 mb-10 relative text-black bg-white min-w-sm max-w-2xl flex flex-col md:flex-row items-center justify-center border py-2 px-2 rounded-2xl gap-2 shadow-2xl focus-within:border-gray-300"
    htmlFor="search-bar">
    <input id="search-bar" ref={inputRef} placeholder="your keyword here"
